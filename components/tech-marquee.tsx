        ...
        {duplicatedItems.map((item, index) => (
          <span
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.WebkitTextStrokeWidth = "0"
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.color = "transparent"
              e.currentTarget.style.WebkitTextStrokeWidth = "1px"
            }}
          >
            {item}
...
export function TechMarquee() {
  return (
    <section id="tools" className="relative py-24 overflow-hidden md:py-32">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">03 — TOOLS LEARNED</p>
      </motion.div>
